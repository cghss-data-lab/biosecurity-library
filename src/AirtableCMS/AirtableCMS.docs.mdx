...
> import CMS from '@talus-analytics/library.airtable-cms'
>
> import useHomepageData from '../cmsHooks/useHomepageData'
> import useCMSIconsQuery from '../cmsHooks/useCMSIconsQuery'
>
...
>
> const HomePage = () => {
>   // icons hook should go in a layout component
>   const icons = useCMSIconsQuery()
...
>
>   return (
>     // IconProvider should go in a
>     // site-wide layout component
